...
<div class="header">
    ...
    <div class="nav">
      <a href="<%=basePath%>content/Blog/index.jsp">文章</a>
      <a href="<%=basePath%>content/Blog/whisper.jsp"  class="active">微语</a>
    ...
    <ul class="layui-nav header-down-nav">
      <li class="layui-nav-item"><a href="<%=basePath%>content/Blog/index.jsp">文章</a></li>
      <li class="layui-nav-item"><a href="<%=basePath%>content/Blog/whisper.jsp"  class="active">微语</a></li>
      <li class="layui-nav-item"><a href="<%=basePath%>content/Blog/leacots.jsp">留言</a></li>
      <li class="layui-nav-item"><a href="<%=basePath%>content/Blog/album.jsp">相册</a></li>
      <li class="layui-nav-item"><a href="<%=basePath%>content/Blog/about.jsp">关于</a></li>
    </ul>
      ...
      <div class="whisper-list">
        <div class="item-box">
          <div class="item">
            ...
            <div class="img-box">
              <img src="<%=basePath%>layui/img/wy_img1.jpg">
            </div>
            <div class="op-list">
          ...
          <div class="review-version layui-hide">
              <div class="form">
                <img src="<%=basePath%>layui/img/header2.png">
              ...
              <div class="list-cont">
                <div class="cont">
                  <div class="img">
                    <img src="<%=basePath%>layui/img/header.png" alt="">
                  </div>
                  <div class="text">
        ...
        <div class="item-box">
          <div class="item">
            ...
            <div class="img-box">
              <img src="<%=basePath%>layui/img/wy_img2.jpg">
              <img src="<%=basePath%>layui/img/wy_img3.jpg">
              <img src="<%=basePath%>layui/img/wy_img4.jpg">
            </div>
            <div class="op-list">
              <p class="like"><i class="layui-icon layui-icon-praise"></i><span>1200</span></p> 
              <p class="edit"><i class="layui-icon layui-icon-reply-fill"></i><span>1200</span></p>
        ...
        <div class="item-box">
          <div class="item">
            ...
            <div class="img-box">
              <img src="<%=basePath%>layui/img/wy_img5.jpg">
            </div>
            <div class="op-list">
              <p class="like"><i class="layui-icon layui-icon-praise"></i><span>1200</span></p> 
              <p class="edit"><i class="layui-icon layui-icon-reply-fill"></i><span>1200</span></p>
