...
//            String passwd = "myNameJOB123_-+=";
    	String passwd = "1111111111aA";
    	String regexZT = "\\D*";
    	if (passwd.matches(regexZT)) {
			System.out.println("中");
		}
            System.out.println("密码级别："+CheckStrength.checkPasswordStrength(passwd));
            System.out.println("密码强度："+CheckStrength.getPasswordLevel(passwd));
	}
}
